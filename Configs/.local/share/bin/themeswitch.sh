...
sed '1d' "${hydeThemeDir}/hypr.theme" > "${confDir}/hypr/themes/theme.conf" # Useless and already handled by awwwallbash.sh but kept for robustness
gtkTheme="$(
...
"${scrDir}/awwwallpaper.sh" -s "$(readlink "${hydeThemeDir}/wall.set")"
